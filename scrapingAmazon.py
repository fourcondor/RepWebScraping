...
# COOKIE
cookie_value = "zXbb4f6REDW2kG64S/lAk3kkqvHeJJqd671BdTVm81Ebwncz49IQbK948FCYGDzlKMeCvAw6KiMvpYBA6IbQSyPvYldZL5HZ0gVbOR9Mqh/8ENGVyBjEiOYLTEmg1Y3ZJFpR+5zIUCeuOAHfvixUs5yO/qVu/99dRZ34G+8UNv3K0b6iquwwql4C6iSx37qEihN05asnmekhfvrXYr5Pw18SypwHsj4jBKo2T9Bwi90="
...
def menu():
    ...
    # CONFIGURAZIONE WEB DRIVER EDGE
    # Configura il percorso del driver di Microsoft Edge
    driver_path = './msedgedriver.exe'  # Aggiungi l'estensione del file corretta (.exe su Windows)

    # Crea un'istanza del browser Microsoft Edge
    driver = webdriver.Edge(executable_path=driver_path)
    # Accedi al sito web
    driver.get('https://www.amazon.it/b?node=17910224031')
    # Accetta i cookie
    cookie_button = driver.find_element_by_id(
        'cookie-accept-button')  # Sostituisci 'cookie-accept-button' con l'ID del pulsante per accettare i cookie
    cookie_button.click()

    # Crea una sessione
    session = requests.Session()

    # Esegui una richiesta GET per ottenere i cookie e l'HTML della pagina
    response = session.get('https://www.amazon.it/b?node=17910224031')
    ...
    # FINE INIT SESSION WITH AMAZON
    # ebay = requests.get(URL, headers=HEADERS,
    #                     cookies={'session-token': cookie_value})
    categories = BeautifulSoup(content, "html.parser")
    print(categories)
        ...
        try:
            ...
            for link_i in links:
                ...
                if azienda['Nome azienda:'] == 'Amazon':
                    ...
                    estrazioneEcommerce.aggiorna_report_ecommerce(azienda['Nome prodotto'], azienda['E-commerce'])
